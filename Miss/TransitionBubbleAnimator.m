...
#import "TransitionBubbleAnimator.h"

@interface TransitionBubbleAnimator ()<CAAnimationDelegate>

@property (weak, nonatomic) CAShapeLayer *maskLayer;

@end

@implementation TransitionBubbleAnimator
